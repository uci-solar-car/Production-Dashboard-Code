...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(560, 140, 219, 191))
...
" }")
        ...
        spacerItem4 = QtWidgets.QSpacerItem(15, 37, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
