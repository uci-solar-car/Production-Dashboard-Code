...
"color:white;")
        ...
        self.leftArrowIcon = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.leftArrowIcon.setStyleSheet("border-image: url(:/img/leftArrow);")
        self.leftArrowIcon.setText("")
        self.leftArrowIcon.setObjectName("leftArrowIcon")
        self.horizontalLayout.addWidget(self.leftArrowIcon)
...
"font: 75 28pt \"MS Shell Dlg 2\";")
        ...
        self.rightArrowIcon.setText("")
        self.rightArrowIcon.setObjectName("rightArrowIcon")
        self.horizontalLayout.addWidget(self.rightArrowIcon)
